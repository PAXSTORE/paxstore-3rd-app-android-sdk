...
Download parameter
Inquire update for 3rd party app
By using this SDK, developers can easily integrate with PAXSTORE. Please take care of your AppKey and AppSecret that generated by PAXSTORE system when you create an app. Refer to the following steps for integration.

Step 1: Get Secret Key
Create a new app in PAXSTORE, and get AppKey and AppSecret from DEV INFO.

Step 2: Download AAR
Please download the AAR from Downloads page

Step 3: Add the Dependency
1.Put aar package into 'libs' folder.

2.Declare repositories in your app build.gradle
...
3.Add dependency
    ...
    dependencies {
        ...
        compile(name:'paxstore-sdk-android-5.02.02', ext:'aar')
    }
...
<!-- Allows an application to read and write the external storage data -->
...
Step 6：Download Parameters API
...
Step 7: Update Inquirer (Optional)
